...
{
    resize(1300, 400);
    setWindowTitle(tr("AveroPay") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/AveroPay"));
    setWindowIcon(QIcon(":icons/AveroPay"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the AveroPay Blockchain"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a AveroPay address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show AveroPay Masternodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    proofOfImageAction = new QAction(QIcon(":/icons/data"), tr("&Proof of Data"), this);
    proofOfImageAction ->setToolTip(tr("Timestamp Files on the AveroPay blockchain."));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About AveroPay"), this);
    aboutAction->setToolTip(tr("Show information about AveroPay"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for AveroPay"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("AveroPay client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("AveroPay client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AveroPay network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    {
        progressBarLabel->setText(tr("Connecting to AveroPay network..."));
...
void BitcoinGUI::showConfEditor()
{
    ...
    /* Open AveroPay.conf with the associated application */
    if (boost::filesystem::exists(pathConfig)) {
        QDesktopServices::openUrl(QUrl::fromLocalFile(QString::fromStdString(pathConfig.string())));
	} else {
		QMessageBox::warning(this, tr("No AveroPay.conf"),
        tr("Your AveroPay.conf does not exist! Please create one in your AveroPay data directory."),
...
void BitcoinGUI::showMNConfEditor()
{
    ...
    if (boost::filesystem::exists(pathMNConfig)) {
        ...
        tr("Your masternode.conf does not exist! Please create one in your AveroPay data directory."),
        QMessageBox::Ok, QMessageBox::Ok);
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid AveroPay address or malformed URI parameters."));
    }
